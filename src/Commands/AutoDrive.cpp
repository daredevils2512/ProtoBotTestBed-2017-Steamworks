...
void AutoDrive::Initialize() {
	...
	m_rightSpeed = Robot::drivetrain->AutoCalcSpeeds(m_radius, m_outerSpeed, m_direction).rightSpeed;
}

// Called repeatedly when
//this Command is scheduled to run
void AutoDrive::Execute() {
	//std::cout << "AutoDrive" << std::endl;
	Robot::drivetrain->DriveRobotTank(m_leftSpeed, m_rightSpeed);
	std::cout << "AutoDrive: Executed" << std::endl;
	std::cout << " " << std::endl;
}
